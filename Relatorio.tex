...
\chapter{Implementação da Ferramenta de Análise de Timing}
	...
	\section{Atraso das Interconexões}
		...
		No modelo de grafo $I(C, R)$ proposto, o conjunto dos vértices, ou capacitores $C$, é composto pelos nodos internos da interconexão, ou capacitores, juntamente com seus valores de capacitâncias. As arestas do grafo representam os resistores, onde cada resitor conecta dois capacitores com um valor de resistência. Sendo assim:
		\begin{equation}
			C = \{((u, c) | c > 0\}.
		\end{equation}
		\begin{equation}
