...
As células marcadas apresentam os valores que são otimistas em relação do \textit{PrimeTime} (i. e., que são menores que os obtidos pelo \textit{PrimeTime}), correspondendo a 29 dos 32 valores obtidos. As células não marcadas indicam que o valor obtido é maior ou igual ao calculado pela ferramenta industrial.
